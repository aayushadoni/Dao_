...
module.exports = async function (deployer) {
    ...
    await token.membership({ from: voter1 })
    await token.approval(amount,{ from: executor })
    await token.membership({ from: voter2 })
    await token.approval(amount,{ from: executor })
    await token.membership({ from: voter3 })
    await token.approval(amount,{ from: executor })
    await token.membership({ from: voter4 })
    await token.approval(amount,{ from: executor })
    await token.membership({ from: voter5 })
    await token.approval(amount,{ from: executor })
